...
import fastcampus.aop.part3.part3_chapter06.databinding.ItemChatListBinding

class ChatListAdapter(val onItemClicked: (ChatListItem) -> Unit): androidx.recyclerview.widget.ListAdapter<ChatListItem, ChatListAdapter.ViewHolder>(diffUtil) {
